        ...
        <div class="FORM-text">
            ...
            if (isset($_GET['error'])) {
                if ($_GET['error'] == "invalidusername&email") {
                    ...
                    echo '<p class="msg-erreur">Username invalide !</p>';
                } else if ($_GET['error'] == "PWDdontmatch") {
                    echo '<p class="msg-erreur">Les mots de passe ne sont pas identique !</p>';
                } else if ($_GET['error'] == "USERNAMETAKEN") {
                    echo '<p class="msg-erreur">Username déjà pris !</p>';
                }
            }
            ?>
